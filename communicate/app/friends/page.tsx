...
export default function FriendsPage() {
  ...
  async function fetchFriends() {
    ...
    try {
      ...
      let url =
        "https://avhs2he1e8.execute-api.ca-central-1.amazonaws.com/default/get-friends?" +
  ...
  const filteredFriends = friends.filter(
    (friend: Friend) =>
      ...
      (friend.major &&
        friend.major.toLowerCase().includes(searchKeyword.toLowerCase())) ||
      (friend.year &&
        friend.year.toString().includes(searchKeyword.toLowerCase()))
  );
            ...
            <div className="flex flex-row py-4">
              ...
              <div className={styles.filter}>
                ...
                <div
                  ...
                  onClick={() => handleFilterClick("Discover")}
                >
                  Discover
                </div>
              </div>
