...
//       let url = 'https://7mjv5vj8l9.execute-api.ca-central-1.amazonaws.com/default/manage-class-items?' + queryParams.toString();
...
//       const queryParams = new URLSearchParams();
//       queryParams.append('userID', userID);
//       let url = 'https://7mjv5vj8l9.execute-api.ca-central-1.amazonaws.com/default/get-class?' + queryParams.toString();
...
//         let url = 'https://7mjv5vj8l9.execute-api.ca-central-1.amazonaws.com/default/class-enroll?' + queryParams.toString();
...
export default function Classes() {
 ...
 useEffect(() => {
  ...
  async function deleteClassItem(uniqueID: string, itemInput: string, selectedDate: Date | null) {
    ...
    let url = 'https://si3agv274d.execute-api.ca-central-1.amazonaws.com/default/manage-class-items?' + queryParams.toString();
    // let url = `https://ahjyyh4enmm3q7dxpts6wafviy0xqwqy.lambda-url.ca-central-1.on.aws/?type=${"add"}`;
    const response = await fetch(url, {
      method: 'POST',
      headers: {
 ...
 // // Fetch all classes from the db that matches auth.currentUser.uid and put the results in setselectedClasses
  async function fetchClasses() {
    try {
      ...
      const queryParams = new URLSearchParams();
      queryParams.append('userID', userID);
      let url = 'https://si3agv274d.execute-api.ca-central-1.amazonaws.com/default/get-class?' + queryParams.toString();
  ...
  async function unEnroll() {
      try {
        ...
        let url = 'https://si3agv274d.execute-api.ca-central-1.amazonaws.com/default/class-enroll?' + queryParams.toString();
        // let url = `https://htd3uel2yernvl4wim2mjgompy0mdpik.lambda-url.ca-central-1.on.aws/?type=${"unenroll"}`;
        const response = await fetch(url, {
          method: 'POST',
          headers: {
