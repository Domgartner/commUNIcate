...
export default function Classes() {
  ...
  async function deleteClassItem(
    ...
    let url = 'https://avhs2he1e8.execute-api.ca-central-1.amazonaws.com/default/manage-class-items?' + queryParams.toString();
  ...
  async function fetchClasses() {
    try {
      ...
      queryParams.append('userID', userID || '');
      let url = 'https://avhs2he1e8.execute-api.ca-central-1.amazonaws.com/default/get-class?' + queryParams.toString();
      ...
      const itemDetails = items.map(
        (item: { itemName: any; date: any; id: any; class: any }) => ({
          title: item.itemName,
          date: item.date,
          id: item.id,
      ...
      classes = classes.filter(
        (className: string) => className.trim() !== "LoserNoClasses"
      );
      ...
      const upcomingItemsObj = classNames.reduce(
      ...
      itemDetails.forEach(
        (item: { id: any; title: any; date: any; className: any }) => {
  ...
  async function unEnroll() {
      try {
        ...
        let url = 'https://avhs2he1e8.execute-api.ca-central-1.amazonaws.com/default/class-enroll?' + queryParams.toString();
        ...
        <div>
          ...
          {selectedClass && (
            <div className="flex">
              <div className="w-1/3 flex px-4">
                <div className="mainContent justify-center items-center w-full">
                  ...
                  <div>
                    <div
                      style={{ height: "50vh" }}
                      className="bg-olive bg-opacity-20 p-4 rounded-lg mb-4 h-96 shadow-lg"
                    >
              ...
              <div className="w-2/3">
                <div style={{ height: "66.666vh" }} className="p-8">
                  <Calendar
                    localizer={localizer}
                    events={events}
                    startAccessor="start"
