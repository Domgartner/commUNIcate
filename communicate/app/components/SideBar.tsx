    ...
    return (
      <Sidebar className="text-sans bg-bleh h-full fixed left-0 right-0 " collapsed={collapsed}>
        ...
        <div className="flex flex-col items-star pt-20">
          ...
          <button className='flex flex-row pt-5 pb-4 rounded-xl hover:bg-blue focus:outline-none focus:ring-4 focus:ring-blue-300' id={styles.classes} onClick={() => handleNavItemClick('classes')}>
            <FontAwesomeIcon icon={faGraduationCap} className='text-baby-blue text-md ml-9'/>
