...
export default function Profile() {
    ...
    //     setIsChanged(true);
    //     const { value } = e.target;
    //     setYear(value); // Set the year directly with the string value
    ...
    async function handleSave() {
        ...
        try {
            ...
            let url = '----Update Profile URL APIGATEWAY-----?' + queryParams.toString()
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                ...
                let url = '---ADD updateprofile API Gateway URL -----?' + queryParams.toString()
                // const response = await fetch(url);
                const response = await fetch(url, {
                    method: 'POST',
                    headers: {
